...
{
    public sealed partial class Test1OOPCourseForm : Project.Forms.BaseTestForm
    {
        public Test1OOPCourseForm()
        {
            InitializeComponent();
        }
        public Test1OOPCourseForm(User user, Course course, int testId) : base(user, course, testId)
        {
            InitializeComponent();
